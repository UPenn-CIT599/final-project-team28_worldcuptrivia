...
public class AlexaHandlerCancel implements RequestHandler {
    @Override
    ...
    public Optional<Response> handle(HandlerInput input) {
        String speechText = "Goodbye. Come back soon to hear a world cup fact";
        return input.getResponseBuilder()
                .withSpeech(speechText)
                .withSimpleCard("World Cup Triva", speechText)
                .build();
    }
}
