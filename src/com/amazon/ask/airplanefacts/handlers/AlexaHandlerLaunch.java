...
public class AlexaHandlerLaunch implements RequestHandler {
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        String title = "Wolrd Cup trivia";
        String primaryText = "Welcome to Wolrd Cup trivia.";
        String secondaryText = "Would you like to hear some Wolrd Cup trivia?";
        String speechText = "Welcome to Wolrd Cup trivia. I can tell you facts about the world cup. Would you like to hear a world cup fact?";
