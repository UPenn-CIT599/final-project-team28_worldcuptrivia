...
public class AlexaHandlerFact implements RequestHandler {
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        String speechText = "<speak> " + primaryText + "<break time=\"1s\"/>  Would you like to hear more Wolrd Cup trivia?" + " </speak>";
